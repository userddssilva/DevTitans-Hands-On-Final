...
import com.android.systemui.litert.NotificationSummaryHook;
...
public class NotificationListener extends NotificationListenerWithPlugins implements
    ...
    // No topo da classe, adicione o campo:
    private NotificationSummaryHook mLiteRtHook;
    ...
    public NotificationListener(
        ...
        mLiteRtHook = new NotificationSummaryHook(context);
    }
    ...
    public void onNotificationPosted(final StatusBarNotification sbn,
        ...
        // Dentro de onNotificationPosted(StatusBarNotification sbn):
        mLiteRtHook.onNotificationPosted(sbn, (key, summary) -> {
            // Aqui você pode logar por enquanto para testar
            Log.d("LiteRt", "Notificação " + key + " resumida: " + summary);
            // TODO: atualizar a view da notificação com o resumo
        });
    }
